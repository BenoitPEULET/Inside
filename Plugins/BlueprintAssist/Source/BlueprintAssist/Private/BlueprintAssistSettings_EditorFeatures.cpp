...
UBASettings_EditorFeatures::UBASettings_EditorFeatures(const FObjectInitializer& ObjectInitializer)
{
	...
	MulticastAffix = FBAStringAffix("Multicast_", EBAAffixType::Prefix);
	ServerAffix = FBAStringAffix("Server_", EBAAffixType::Prefix);
	ClientAffix = FBAStringAffix("Client_", EBAAffixType::Prefix);
